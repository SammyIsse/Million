...
def scrape_kvickly():
    url = "https://kvickly.coop.dk/avis/"
    ...
    try:
        ...
        _BLOCKED_NAME_FRAGMENTS = {
            ...
            'skyllemiddel', 'stegepande', 'sneakers', 'solseng', 'parasol', 'badeklæde', 'fuglebad', 'smartstore',
...
def main():
    ...
    filename = os.path.join(_ROOT_DIR, 'Xlsx filer', 'Kvickly_produkter.xlsx')
    wb.save(filename)
